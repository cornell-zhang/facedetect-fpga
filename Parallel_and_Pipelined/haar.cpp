...
//inline void get_all_data( uint18_t output[12], uint10_t addr_list[12], bit enable_list[12], uint18_t aa[ROWS*COLS])
...
CHOOSE_DATA:
  ...
  {
    #pragma HLS unroll
    //output[i] = enable_list[i] ? data_from_banks[bank[i]]  : uint18_t("0",10);
